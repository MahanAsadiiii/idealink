...
const Proposal = () => {
    return (
        <Section>
            <div className='flex justify-between w-full mx-auto mb-8 gap-3'>
                <div className="bg-[#F5FFFC] px-6 py-8 basis-1/2 rounded border-b-2 border-[#81E09D]">
                ...
                <div className="bg-[#fef3f3] px-6 py-8 basis-1/2 rounded border-b-2 border-[#EEA1A2]">
                    <div className="flex mb-[16px] ">
