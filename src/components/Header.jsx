      ...
      <Section>
        <div className='flex w-full flex-col mt-12 md:mt-56 justify-center relative'>
          <div className='flex flex-col  justify-center'>
            <h2 className='text-black text-lg md:text-4xl font-bold flex justify-center'>Sell Smarter <span className='text-base mx-2 md:mx-4 md:text-2xl '>with</span> <span className='text-[#1A9DAE] md:text-4xl'>AI-Personality Analysis</span></h2>
          ...
          <InputUrl className='mt-5 md:mt-8' />
        </div>
      </Section>
    </div>
