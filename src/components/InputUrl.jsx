    ...
    return (
            <div className={`bg-[#ffffff] flex flex-col px-2 py-2 lg:px-8 lg:py-6 rounded-lg w-full lg:w-full  ${props.className}`}>
                ...
                <div className='flex justify-between mt-2 bg-white '>
                    ...
                    <a href="/reports" className='bg-[#1A9DAE] rounded flex justify-center text-white text-xs lg:text-base lg:font-semibold px-3 py-2 lg:basis-1/6 lg:px-8 lg:py-3'>Analyze</a>
                </div>
            </div>
    )
}
